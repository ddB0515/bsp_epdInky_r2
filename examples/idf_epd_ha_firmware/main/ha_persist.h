 ...
 *
 * One NVS namespace (HA_NVS_NAMESPACE), holding whatever the captive portal
 * collected: Wi-Fi credentials, MQTT broker/credentials, the dashboard image
 * URL and HA token, and the refresh interval. Nothing here is compiled in -
 * see ha_config.h's header comment.
 *
